...
//        dto.setIdSize(ctsp.getIdSize());
//        dto.setIdMau(ctsp.getIdMau());
//
//        // Lấy tên size
//        if (ctsp.getIdSize() != null) {
//            sizeRepo.findById(ctsp.getIdSize()).ifPresent(size -> {
//                dto.setTenSize(size.getTenSZ());
//            });
//        }
//
//        // Lấy tên màu
//        if (ctsp.getIdMau() != null) {
//            mauSacRepo.findById(ctsp.getIdMau()).ifPresent(mau -> {
